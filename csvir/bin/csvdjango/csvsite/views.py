...
def editcsv(request):
    ...
    datacsv=csvdoc.CSVFILE().display('/home/dozmen/Desktop/csvir/bin/csvdjango/static/gkts.csv')
    ...
    if request.POST:
        ...
        with open('/home/dozmen/Desktop/csvir/bin/csvdjango/static/gkts.csv',"w") as fw:
